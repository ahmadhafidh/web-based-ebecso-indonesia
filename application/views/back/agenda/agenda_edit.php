      ...
      <?php echo form_open_multipart($action);?>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-body">
              <div class="form-group"><label>Judul agenda</label>
                <?php echo form_input($judul_agenda, $agenda->judul_agenda);?>
              </div>
              <div class="form-group"><label>Isi agenda</label>
                <?php echo form_textarea($isi_agenda,$agenda->isi_agenda);?>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-body">
              <div class="row">
                <div class="col-xs-4"><label>Author</label>
                  <?php echo form_input($author,$agenda->author); ?>
                </div>
                <div class="col-xs-4"><label>wilayah</label>
                  <?php echo form_dropdown('',$get_combo_wilayah,$agenda->wilayah,$wilayah_css);?>
                </div>
                <div class="col-xs-4"><label>Status Publish</label>
                  <?php echo form_dropdown('', $publish_option, $agenda->publish, $publish_css); ?>
                </div>
              </div><br>
              <div class="form-group"><label>Gambar Sebelumnya</label><br>
                <img src="<?php echo base_url('assets/images/agenda/'.$agenda->userfile.$agenda->userfile_type.'') ?>" width="200px"/>
              </div>
            ...
            <?php echo form_input($id_agenda,$agenda->id_agenda);?>
